...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2736265922ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diario-secreto&table=diario">`diario-secreto`.`diario`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=diario-secreto&table=usuarios">`diario-secreto`.`usuarios`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="75707a467b6c60766d5c452842326367">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="diario-secreto" targettable="usuarios">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `diario-secreto`.`usuarios` ( `id` INT NOT NULL AUTO_INCREMENT ,  `email` TEXT NOT NULL ,  `password` TEXT NOT NULL ,  `diario` TEXT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `usuarios`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="diario-secreto" targettable="diario">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `diario`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="diario-secreto" targettable="diario">
                            <div class="action_content">
